...
import { Filter, Plus, RefreshCw, Search, Trash2, Pencil, ReceiptText } from 'lucide-vue-next'
...
const entries = ref<Entry[]>([]), members = ref<Member[]>([]), categories = ref<Category[]>([]), total = ref(0), loading = ref(true), error = ref(''), drawer = ref(false), saving = ref(false), editing = ref<Entry | null>(null)
